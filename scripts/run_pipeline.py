...
def main(args):
    ...
    # mlruns_path = args.mlflow_uri or r"C:\Users\LENOVO\OneDrive\Bureau\Projects\Chrun prediction\mlruns"  # Local file-based tracking
    mlruns_path = args.mlflow_uri or "file:///C:/Users/LENOVO/OneDrive/Bureau/Projects/Chrun prediction/mlruns"
    ...
    with mlflow.start_run():
        ...
        model = XGBClassifier(
            # Tree structure parameters ( best params obtened by optuna {see EDA.ipynb})
            n_estimators=741,        # Number of trees 
            learning_rate=0.018,     # Step size shrinkage (OPTIMIZED)  
            max_depth=3,            # Maximum tree depth (OPTIMIZED)
            
            # Regularization parameters
            subsample=0.99,         # Sample ratio of training instances
            colsample_bytree=0.88,  # Sample ratio of features for each tree
